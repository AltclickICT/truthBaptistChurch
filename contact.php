                ...
                <div class="row">
                    <div class="col-md-3 col-md-push-8 animate-box">
                        ...
                        <ul class="contact-info">
                            <li><i class="icon-location4"></i>Off Dr. Alasa Street, Behind Kasham Hotel, Area D, Nyanya, Abuja</li>
                            <li><i class="icon-phone3"></i>07064558837 / 07063336715</li>
                            <li><i class="icon-location3"></i><a href="#">truthbaptistabuja@yahoo.com</a></li>
                            <li><i class="icon-facebook2"></i><a href="#">TBC</a></li>
                        </ul>
                    </div>
                    <div class="col-md-7 col-md-pull-2 animate-box">
                        <div class="row">
                            <form action="mailto:truthbaptistabuja@yahoo.com" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Email" namee="email">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="body" class="form-control" id="" cols="30" rows="7" placeholder="Message"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
