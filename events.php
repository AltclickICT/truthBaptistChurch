                                ...
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3 text-center slider-text">
                                        <div class="slider-text-inner">
                                            <h1>Events</h1>
                                            <h2>We cover arround the world!</a>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="fh5co-events">
                <div class="row animate-box">
                    <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                        <h2>Our Events</h2>
                        <p>To come write contents is a serious task</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 animate-box">
                        <div class="events-entry">
                            ...
                            <p>Writing some stuff for demonstration. Aut cum mollitia reprehenderit. Eos cumque dicta adipisci architecto culpa amet.</p>
